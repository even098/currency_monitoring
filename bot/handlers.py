...
from bot.keyboard import get_actions_markup, get_back_markup, get_subscriptions_markup
from bot.services import register_user, check_currency, subscribe_to_currency, get_currency, get_subscriptions, \
